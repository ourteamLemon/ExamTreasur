...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated activityStyle:(UIActivityIndicatorViewStyle)activityStyle{
	MBProgressHUD *hud = [[MBProgressHUD alloc] initWithView:view activityStyle:activityStyle];
	[view addSubview:hud];
	[hud show:animated];
...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    return [MBProgressHUD showHUDAddedTo:view animated:animated activityStyle:UIActivityIndicatorViewStyleWhiteLarge];
}
...
- (id)initWithFrame:(CGRect)frame activityStyle:(UIActivityIndicatorViewStyle)_myActivityStyle{
	...
	if (self) {
		...
		self.square = NO;
        self.activityIndicatorStyle=_myActivityStyle;
...
- (id)initWithView:(UIView *)view activityStyle:(UIActivityIndicatorViewStyle)activityStyle{
	NSAssert(view, @"View must not be nil.");
	id me = [self initWithFrame:view.bounds activityStyle:activityStyle];
...
- (id)initWithView:(UIView *)view {
    return [self initWithView:view activityStyle:UIActivityIndicatorViewStyleWhiteLarge];
}
