...
- (void)creatTableview
{
    iTable = [[UITableView alloc]initWithFrame:self.view.frame style:UITableViewStylePlain];
...
-(NSString*)getOrderInfo:(NSInteger)index
{
	...
	order.notifyURL =  @"http%3A%2F%2Fwwww.baidu.com"; //回调URL
